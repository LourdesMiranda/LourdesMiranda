...
const lourdes = {
  ...
  focus: ["Backend & Arquitectura", "APIs & Servicios", "E-commerce at scale"],
  alsoLoves: ["UI/UX", "Design systems", "Interfaces cuidadas"],
  funFact: "Empecé en frontend, ahora conecto servidor e interfaz"
};
```
...
- **Enfoque full stack** — conecto backend y frontend sin perder ninguna capa de vista.
- **Visión de negocio e-commerce** — del catálogo al checkout, con foco en impacto.
- **Backend en expansión** — ampliando mi rol hacia arquitectura y lógica de servidor.
- **Criterio de producto y UI** — interfaces cuidadas, no solo código que funciona.
